...
def do_one_stylesheet(pixelSize,colour,filename,debugStopAfter=0):
  ...
  jjc = "body > input#site + input + input + div#wrapper "
  ...
  if pixelSize:
      ...
      css["body > input#site + input + input + div#wrapper > div#header, body > input#site + input + input + div#wrapper > div#regionHeader"]={
  ...
  # if pixelSize: css[exclude_ie_below_9+"input#site + input + input + div#wrapper > div#header > div#menuFrame > ul.menu > li:before"]={"content":"attr(id)","text-transform":"none","display":"inline"}
  ...
  css["body > input#site + input + input + div#wrapper div#content figure > img"]={"*max-width":"100%"}
  ...
  for w in [12,15,16,17,18,20,24,26,28,30,32,36,44,48,100]: doHeightWidth(w,w) # could be navigation icons or similar & there could be very many of them; don't want these to take too much space (e.g. GitHub 'avatars', can be quite simple but still hundreds of pixels big unnecessarily)
