...
def do_one_stylesheet(pixelSize,colour,filename,debugStopAfter=0):
  ...
  if pixelSize:
    ...
    # + more 'news' fixing:
    css["div#main > article > header + div > div.js-right-rail, body > div.asset_inserts + div + div.main > header.js-header"]={"*display":"none"} # Huffington 2017: runaway JS trying to populate it and crashing Firefox
