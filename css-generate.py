...
def do_one_stylesheet(pixelSize,colour,filename,debugStopAfter=0):
  ...
  defaultStyle={
    ...
    "*-moz-osx-font-smoothing":"auto","*font-smooth":"auto", # ('never' might be better but at least some versions of Firefox ignore it)
  ...
  css['div[data-lang^="zh"],div[data-lang^="zh"] *']=css[":lang(zh)"] # this might at least help on some sites (TODO: also set a specific Chinese-rather-than-Japanese font?)
