...
def do_one_stylesheet(pixelSize,colour,filename,debugStopAfter=0):
  ...
  css['article, article div.flex-wrap, main div.row, body > div.container > div.row, body > div.container-fluid > div.row, body > div.flex-container, div.main_content, div[style="max-width:1600px"],div[style="max-width:1600px"] div.Comment,div.post__body,div.dnXaq,div.dHUYIZ,div.ftjuQd,div.oj-flex,main > div']={'*display':'block'} # not flex please (various sites)
