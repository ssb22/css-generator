...
def do_one_stylesheet(pixelSize,colour,filename,debugStopAfter=0):
  ...
  css['div.secondary-nav__left-section > ul.secondary-nav__list'] = { '*display':'block'} # Tesco strikes again.  In 2017-11 their web design department apparently decided anyone with a narrow window (e.g. due to screen magnification) is not allowed to see most of the Clubcard options.  Every little helps... to frustrate our browsing :-(
